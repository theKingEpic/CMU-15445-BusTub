...
class WindowFunctionExecutor : public AbstractExecutor {
 public:
  ...
  auto MakeWinKey(const Tuple *pTuple, std::vector<AbstractExpressionRef> &partition_by) const;

  auto MakeWinValue(const Tuple *pTuple, std::shared_ptr<AbstractExpression> &expr) const;
